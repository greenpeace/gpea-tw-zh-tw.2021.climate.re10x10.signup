const members = [
    ...
    {
        "index": 2,
        "name": "美妝與<br>清潔品<br>零售",
        "data": [
            {
                "img": require("./members/3-1.jpg"),
                "title": "Clarins 新加坡商克蘭詩股份有限公司台灣分公司",
                "description": "知名女性美妝品牌，以「取之自然、尊重自然」為核心，努力不懈創造更美好、更美麗的未來",
            ...
            },
            {
                ...
                "goal": ` <span class="item-year">2030</span> 年使用 <span class="item-percent">100%</span> 綠電`,
            },
            {
    ...
    },
    {
        ...
        "data": [
            ...
            },
            {
                ...
                "title": "若水鑑價股份有限公司",
                "description": "EONE GLOBAL 成員之一，由一群擁有豐富財務會計、創業投資、併購交易及評價分析經驗之專業人士成立，提供企業價值服務、企業評價與資產評價、新創事業輔導等服務",
                "goal": ` <span class="item-year">2025</span> 年使用 <span class="item-percent">10%</span> 綠電`,
            },
            {
            ...
            },
            {
                ...
                "goal": ` <span class="item-year">2035</span> 年使用 <span class="item-percent">50%</span> 綠電`,
            }
        ]
    },
    {
        "index": 8,
        "name": "事務所、<br>診所與<br>商家",
        "data": [
            {
